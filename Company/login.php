...
if (isset($_SESSION['adminData']) && !empty($_SESSION['adminData'])) {
    echo "<script>window.location=\"" . ADMINROOT . "dashboard.php\"</script>";
}
...
<body class="login_page">
                        ...
                        <form class="no-mb no-mt" method="post">
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    ...
                                    <div class="pull-left">
                                        <input type="submit" name="loginbtn" class="btn btn-primary mt-10 btn-corner"
                                            value="Log in">
                                        <a href="forgot-password.php" class="btn mt-10 btn-corner btn-link">Forgot
                                            password?</a>
                                    </div>
                                </div>
                            </div>
    ...
    <script src="assets/js/jquery-1.12.1-ui.min.js" type="text/javascript"></script>
