...
<html lang="en">
    ...
    <body>
        ...
        <div class='page-topbar '>
            <a href="dashboard.html" class='logo-area'><span></span></a>
                    ...
                    <ul class="info-menu right-links list-inline list-unstyled">
                        <li class="profile showopacity">
                            ...
                            <ul class="dropdown-menu profile animated fadeIn">
                                ...
                                <li class="last"><a href="login.html"><i class="fa fa-lock"></i> Logout</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
                        ...
                        <div class="page-title">
                            ...
                            <div class="pull-right">
                                <div class="right-tools">
                                    <a href="add-drivers.html" class="btn btn-primary"><i class="fa fa-chevron-left"></i> <span>Back</span></a>
                                </div>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div class="col-md-10">
                                            <div class="col-lg-6 no-pl">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" class="form-control" placeholder="Enter First Name" value="Wycliffe">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 no-pr">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" class="form-control" placeholder="Enter Last Name" value="Shane">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 no-pl">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" class="form-control"  placeholder="Enter Email Address" value="wycliffe@gmail.com">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 no-pr">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" class="form-control"  placeholder="Enter Phone Number" value="815-569-8534">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 no-pl">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls input-group date" id="datetimepicker1">
                                                        <input type="text" class="form-control" placeholder="Select Birthdate" value="08/10/2018">
                                            ...
                                            <div class="col-lg-12 no-pl">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <textarea class="form-control" rows="5"  placeholder="Enter Address">254, Machakos Rd, Nairobi, Kenya</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 no-pl">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <select class="form-control" name="formfield5">
                                                            <option id="0">Select Country</option>
                                                            <option id="1" selected="">Kenya</option>
                                            ...
                                            <div class="col-lg-6 no-pl">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" class="form-control" placeholder="Enter City" value="Machakos">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 no-pr">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" class="form-control" placeholder="Enter Zipcode" value="765435">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 no-pl">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="password" class="form-control" placeholder="Enter Password" value="123456">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 no-pr">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="password" class="form-control" placeholder="Enter Confirm Password" value="123456">
                                                    </div>
                                                </div>
                                            </div>                                           
                                        </div>
                                ...
                                <div class="tab-pane fade" id="document">
                                    <div class="document-gallery">
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="doc-img">
                                                    <img src="assets/images/driving.licence.jpg" alt=""/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
