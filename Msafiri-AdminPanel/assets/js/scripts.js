/**
 * @Package: Glamus For the Grandeur
 * @Version: 1.0.0
 */
...
jQuery(function ($) {
    ...
    'use strict';
    var GLAMUS_SETTINGS = window.GLAMUS_SETTINGS || {};
    ...
    /*--------------------------------
     Window Based Layout
     --------------------------------*/
    GLAMUS_SETTINGS.windowBasedLayout = function () {
        var width = window.innerWidth;
        //console.log(width);

        if ($("body").hasClass("chat-open") || $("body").hasClass("sidebar-collapse")) {

            GLAMUS_SETTINGS.mainmenuCollapsed();
            ...
            GLAMUS_SETTINGS.mainmenuScroll();
        }
    ...
    /*--------------------------------
     Window Based Layout
     --------------------------------*/
    GLAMUS_SETTINGS.onLoadTopBar = function () {
    ...
    /*--------------------------------
     CHAT API
     --------------------------------*/
    GLAMUS_SETTINGS.chatAPI = function () {
        ...
        $('.page-topbar .toggle_chat').on('click', function () {
            ...
            if (chatarea.hasClass("hideit")) {
                ...
                //GLAMUS_SETTINGS.mainmenuScroll();
                GLAMUS_SETTINGS.windowBasedLayout();
            }
        });
    ...
    /*--------------------------------
     CHAT API Scroll
     --------------------------------*/
    GLAMUS_SETTINGS.chatApiScroll = function () {
    ...
    /*--------------------------------
     CHAT API window
     --------------------------------*/
    GLAMUS_SETTINGS.chatApiWindow = function () {
        ...
        $(document).on('click', ".chatapi-windows .user-window .controlbar img, .chatapi-windows .user-window .controlbar .minimizeit", function (e) {
            ...
            if (!$(".chatapi-windows #user-window" + id).hasClass("minimizeit")) {
                ...
                GLAMUS_SETTINGS.tooltipsPopovers();
            } else {
    ...
    /*--------------------------------
     Login Page
     --------------------------------*/
    GLAMUS_SETTINGS.loginPage = function () {
    ...
    /*--------------------------------
     Search Page
     --------------------------------*/
    GLAMUS_SETTINGS.searchPage = function () {
    ...
    /*--------------------------------
     Viewport Checker
     --------------------------------*/
    GLAMUS_SETTINGS.viewportElement = function () {
    ...
    /*--------------------------------
     ...
     --------------------------------*/
    GLAMUS_SETTINGS.draggablePanels = function () {
    ...
    /*--------------------------------
     ...
     --------------------------------*/
    GLAMUS_SETTINGS.breadcrumbAutoHidden = function () {
    ...
    /*--------------------------------
     Section Box Actions
     --------------------------------*/
    GLAMUS_SETTINGS.sectionBoxActions = function () {
    ...
    /*--------------------------------
     Main Menu Scroll
     --------------------------------*/
    GLAMUS_SETTINGS.mainmenuScroll = function () {
    ...
    /*--------------------------------
     Collapsed Main Menu
     --------------------------------*/
    GLAMUS_SETTINGS.mainmenuCollapsed = function () {
    ...
    /*--------------------------------
     Main Menu
     --------------------------------*/
    GLAMUS_SETTINGS.mainMenu = function () {
    ...
    /*--------------------------------
     Mailbox
     --------------------------------*/
    GLAMUS_SETTINGS.mailboxInbox = function () {
    ...
    /*--------------------------------
     Top Bar
     --------------------------------*/
    GLAMUS_SETTINGS.pageTopBar = function () {
    ...
    /*--------------------------------
     Extra form settings
     --------------------------------*/
    GLAMUS_SETTINGS.extraFormSettings = function () {
    ...
    /*--------------------------------
     js tree
     --------------------------------*/
    GLAMUS_SETTINGS.jsTreeINIT = function () {
    ...
    /*--------------------------------
     Vector maps
     --------------------------------*/
    GLAMUS_SETTINGS.jvectorMaps = function () {
    ...
    /*--------------------------------
     Pretty Photo
     --------------------------------*/
    GLAMUS_SETTINGS.loadPrettyPhoto = function () {
    ...
    /*--------------------------------
     Gallery
     --------------------------------*/
    GLAMUS_SETTINGS.isotopeGallery = function () {
    ...
    /*--------------------------------
     Tocify
     --------------------------------*/
    GLAMUS_SETTINGS.tocifyScrollMenu = function () {
    ...
    /*--------------------------------
     Full Calendar
     --------------------------------*/
    GLAMUS_SETTINGS.uiCalendar = function () {
    ...
    /*--------------------------------
     ...
     --------------------------------*/
    GLAMUS_SETTINGS.nestableList = function () {
    ...
    /*--------------------------------
     Tooltips & Popovers
     --------------------------------*/
    GLAMUS_SETTINGS.tooltipsPopovers = function () {
    ...
    /*--------------------------------
     iCheck
     --------------------------------*/
    GLAMUS_SETTINGS.iCheck = function () {
    ...
    /*--------------------------------
     Form Editors
     --------------------------------*/
    GLAMUS_SETTINGS.formEditors = function () {
    ...
    /*--------------------------------
     Custom Dropzone
     --------------------------------*/
    GLAMUS_SETTINGS.customDropZone = function () {
    ...
    /*--------------------------------
     ...
     --------------------------------*/
    GLAMUS_SETTINGS.otherScripts = function () {
    ...
    /*--------------------------------
     Widgets
     --------------------------------*/
    GLAMUS_SETTINGS.CRYPTONIAWidgets = function () {
    ...
    /*--------------------------------
     weather widget
     --------------------------------*/
    GLAMUS_SETTINGS.CRYPTONIAWidgetWeather = function () {
    ...
    /*--------------------------------
     To Do Task Widget
     --------------------------------*/
    GLAMUS_SETTINGS.CRYPTONIAToDoWidget = function () {
    ...
    /*--------------------------------
     ...
     --------------------------------*/
    GLAMUS_SETTINGS.CRYPTONIAToDoAddTaskWidget = function () {
        ...
        $(".wid-add-task input").on('keypress', function (e) {
            if (e.keyCode == 13) {
                ...
                $(this).val("");
                $(this).focus();
                GLAMUS_SETTINGS.iCheck();
                GLAMUS_SETTINGS.CRYPTONIAToDoWidget();
    ...
    /*--------------------------------
     Vector maps
     --------------------------------*/
    GLAMUS_SETTINGS.dbjvectorMap = function () {
    ...
    /*--------------------------------
     IOS7 Switchery
     --------------------------------*/
    GLAMUS_SETTINGS.ios7Switchery = function () {
    ...
    /*--------------------------------
     ...
     --------------------------------*/
    GLAMUS_SETTINGS.widgetSparklineChart = function () {
...
// Element Attribute Helper
    ...
    $(document).ready(function () {
        GLAMUS_SETTINGS.windowBasedLayout();
        GLAMUS_SETTINGS.mainmenuScroll();
        GLAMUS_SETTINGS.mainMenu();
        GLAMUS_SETTINGS.mainmenuCollapsed();
        GLAMUS_SETTINGS.pageTopBar();
        GLAMUS_SETTINGS.otherScripts();
        GLAMUS_SETTINGS.iCheck();
        GLAMUS_SETTINGS.customDropZone();
        GLAMUS_SETTINGS.formEditors();
        GLAMUS_SETTINGS.extraFormSettings();
        GLAMUS_SETTINGS.tooltipsPopovers();
        GLAMUS_SETTINGS.nestableList();
        GLAMUS_SETTINGS.uiCalendar();
        GLAMUS_SETTINGS.tocifyScrollMenu();
        GLAMUS_SETTINGS.loadPrettyPhoto();
        GLAMUS_SETTINGS.jvectorMaps();
        GLAMUS_SETTINGS.jsTreeINIT();
        GLAMUS_SETTINGS.breadcrumbAutoHidden();
        GLAMUS_SETTINGS.chatAPI();
        GLAMUS_SETTINGS.chatApiScroll();
        GLAMUS_SETTINGS.chatApiWindow();
        GLAMUS_SETTINGS.mailboxInbox();
        GLAMUS_SETTINGS.CRYPTONIAWidgets();
        GLAMUS_SETTINGS.sectionBoxActions();
        GLAMUS_SETTINGS.draggablePanels();
        GLAMUS_SETTINGS.viewportElement();
        GLAMUS_SETTINGS.searchPage();
        GLAMUS_SETTINGS.CRYPTONIAToDoAddTaskWidget();
        GLAMUS_SETTINGS.CRYPTONIAToDoWidget();
        GLAMUS_SETTINGS.dbjvectorMap();
        GLAMUS_SETTINGS.widgetSparklineChart();
        GLAMUS_SETTINGS.CRYPTONIAWidgetWeather();
        GLAMUS_SETTINGS.onLoadTopBar();
        GLAMUS_SETTINGS.ios7Switchery();
    });
    ...
    $(window).resize(function () {
        ...
        //GLAMUS_SETTINGS.mainmenuScroll();
        //GLAMUS_SETTINGS.CRYPTONIAWidgetWeather();
        GLAMUS_SETTINGS.isotopeGallery();
        GLAMUS_SETTINGS.loginPage();
        GLAMUS_SETTINGS.widgetSparklineChart();
    });
