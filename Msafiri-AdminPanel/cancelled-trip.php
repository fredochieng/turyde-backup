<?php 
$pageName = 'reports';
$subpageName = 'cancelled-trip';
require_once 'adminHeader.php';?>
<?php
if(isset($_GET) && !empty($_GET['driver_id']) && empty($_GET['daterange'])){
    $selectUser = "SELECT t1.*,t2.fullname FROM tbl_driver_setlocation as t1 INNER JOIN tbl_driverdata as t2 ON t1.driver_id=t2.id WHERE t1.status = 'cancel' AND t1.driver_id = '".$_GET['driver_id']."'";
}
elseif(isset($_GET) && !empty($_GET['daterange']) && empty($_GET['driver_id'])){
    ...
    $selectUser = "SELECT t1.*,t2.fullname FROM tbl_driver_setlocation as t1 INNER JOIN tbl_driverdata as t2 ON t1.driver_id=t2.id WHERE t1.status = 'cancel' AND (t1.datetime BETWEEN '".$fromdate."' AND '".$endDate."')";
}
elseif(isset($_GET) && !empty($_GET['driver_id']) && !empty($_GET['daterange'])){
    ...
    $fromdate = $getdate[0] . " 00:00:00";
    $endDate = $getdate[1]. " 23:59:59";
    $selectUser = "SELECT t1.*,t2.fullname FROM tbl_driver_setlocation as t1 INNER JOIN tbl_driverdata as t2 ON t1.driver_id=t2.id WHERE t1.status = 'cancel' AND t1.driver_id = '".$_GET['driver_id']."' AND (t1.datetime BETWEEN '".$fromdate."' AND '".$endDate."')";
}
else{
    $selectUser = "SELECT t1.*,t2.fullname FROM tbl_driver_setlocation as t1 INNER JOIN tbl_driverdata as t2 ON t1.driver_id=t2.id WHERE t1.status = 'cancel'";
}
    ...
    <div class="wrapper main-wrapper row" style=''>
        <div class='col-xs-12'>
            <div class="page-title">
                <div class="pull-left">
                    <h1 class="title">Cancelled Trip</h1>
                </div>
                        ...
                        <form class="search-form" method="get">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <a href="<?php echo ADMINROOT;?>cancelled-trip.php" class="btn btn-primary">Reset</a>
                                </div>
                            </div>
                        </form>
                    </section>
        ...
        <div class="col-lg-12">
            <section class="box has-border-left-3">
                <!-- <header class="panel_header">
                    <h2 class="title pull-left">Cancelled Trip List</h2>
                </header> -->
                                ...
                                <table id="example" class="table table-small-font no-mb table-bordered table-striped">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="no-sort">Trip Number</th>
                                            <th class="text-left">Driver Name</th>
                                            <th class="text-left">Cancel Reason</th>
                                    ...
                                    <?php
                                        ...
                                        <tr>
                                            ...
                                            <td>TRIP00<?php echo $dataselectUser['id']; ?></td>
                                            <td><?php echo $dataselectUser['fullname'];?></td>
                                            <td><?php echo $dataselectUser['cancel_reason'];?></td>
